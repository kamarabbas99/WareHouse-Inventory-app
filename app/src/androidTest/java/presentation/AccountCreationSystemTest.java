...
public class AccountCreationSystemTest {
    ...
    @Test
    public void accountCreationSystemTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.inputUsername),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("TestAccount"), closeSoftKeyboard());

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.inputPasword),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.verifyPassword),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction materialCheckBox = onView(
                allOf(withId(R.id.isAdmin), withText("Is Admin"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.username),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("TestAccount"), closeSoftKeyboard());
        ...
        AccountPersistence accountDB = DatabaseManager.getAccountPersistence();
